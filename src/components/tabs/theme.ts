...
const tabs = {
  ...
  content: 'w-full',
  item: {
    base: 'flex font-regular relative outline-none rounded-4 py-1 px-4 cursor-pointer text-center justify-center text-caption-l hover:text-light transition-colors duration-150 ease-easing',
